...
namespace TDMWeb.Extensions
{
    public static class HtmlHelpers
    {
        public static MvcHtmlString InputFile(this HtmlHelper helper, string name, string label)
        {
            ...
            builder.Append(String.Format("      <input style='visibility: hidden; position: absolute; top: -5000px; left: -5000px;' type='file' multiple accept='.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel' id = '{0}' name='{0}[]'>", name));
            builder.Append(String.Format("      <input type='text' class='form-control input-file-filename' name='{0}_filename' placeholder='Nenhum arquivo selecionado...' readonly='readonly'>", name));
